# ========================================
# COMPUTE - WEB TIER MODULE
# ========================================
# Web servers with Blue/Green deployment support
# ========================================
...
resource "aws_launch_template" "web_blue" {
  name_prefix   = "${var.project_name}-web-lt-blue-"
...
resource "aws_launch_template" "web_green" {
  name_prefix   = "${var.project_name}-web-lt-green-"
